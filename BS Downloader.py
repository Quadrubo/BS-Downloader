...
class Win1:
    ...
    def show_widgets(self):
        ...
        """
        self.label_already = Label(self.frame, text="Existing Downloads: ")
        self.label_already.grid(row=2, column=0)
        """
...
class Win2(Win1):
    ...
    def save_config(self):
        data = {
            "dlfolder": "C:\\OperaDownloads",
            "profile": "C:\\Users\\Julian\\AppData\\Roaming\\Opera Software\\Opera Stable",
            "bin": "C:\\Users\\Julian\\AppData\\Local\\Programs\\Opera\\74.0.3911.160\\opera.exe"
        }
